...
const srcDb = path.join(src, 'tyowiki.db');
if (!fs.existsSync(srcDb)) {
  console.error('Kelvollista varmuuskopiota ei löydy (tyowiki.db puuttuu):', src);
  process.exit(1);
}
...
fs.copyFileSync(srcDb, path.join(DATA_DIR, 'tyowiki.db'));
